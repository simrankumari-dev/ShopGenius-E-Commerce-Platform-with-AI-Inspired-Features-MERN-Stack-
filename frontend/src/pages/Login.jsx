...
function Login() {
    let [show,setShow] = useState(false)
        ...
        let {getCurrentUser} = useContext(UsetDataContext)
  ...
  return (
    ...
    <h1 className='text-[22px] font-sans '>ShopGenius</h1>
    </div>

    <div className='w-[100%] h-[100px] flex items-center justify-center flex-col gap-[10px]'>
        <span className='text-[25px] font-semibold'>Login Page</span>
        <span className='text-[16px]'>Welcome to ShopGenius, Place your order</span>
